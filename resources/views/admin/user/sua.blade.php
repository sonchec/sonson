        ...
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                <form action="admin/user/sua/{{$user->id}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control" name="email" placeholder="Nhập Tên" value="{{$user->email}}" readonly />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="passwordAgain" class="form-control password" name="password" disabled>
                    </div>
                    <div class="form-group">
